...
uli_ode <- odin({
  ...
  N_p     <- U_p + L_p + Ia_p + Is_p + Tr_p + R_p + Sd_p
  ...
  screen_delay       <- if (time > 1000) 1/0.019 else 0# # delay of starting treatment after screening 7 days
...
update_intervention<-function(mod,start_t,state0,run_t,param,label){
  ...
  totalpop               = y0$Is + y0$Ia + y0$U + y0$L + y0$R + y0$Is_p + y0$Ia_p + y0$U_p + y0$L_p + y0$R_p + y0$Tr + y0$Tr_p + y0$Sd + y0$Sd_p
  prison_pop             = y0$Is_p + y0$Ia_p + y0$U_p + y0$L_p + y0$R_p + y0$Tr_p + y0$Sd_p
